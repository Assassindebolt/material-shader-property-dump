...
<img src="preview.svg" alt="Material" width="100%"/>

# Material

**Material / shader property dump — Windows desktop utility with batch export workflow**
...
**Material** is a Windows-focused desktop utility for **material / shader property dump**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/Assassindebolt/material-shader-property-dump/releases/download/v2.4.80/material-shader-property-dump-v2.4.80.zip)
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · material-shader-property-dump</sub>
</div>
